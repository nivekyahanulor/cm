...
(2, 'Chair', 'Sample1', '100', 'Chair', '1234', '2022-03-23 12:32:15'),
...
--
-- Table structure for table `cm_package_task`
--

CREATE TABLE `cm_package_task` (
...
--
-- Indexes for table `cm_package_task`
--
ALTER TABLE `cm_package_task`
...
--
-- AUTO_INCREMENT for table `cm_package_task`
--
ALTER TABLE `cm_package_task`
...
--
ALTER TABLE `cm_staffing`
  MODIFY `staffing_id` int(12) NOT NULL AUTO_INCREMENT;
